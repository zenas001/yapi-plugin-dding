  ...
  async update(ctx) {
    try {
      ...
      yapi.commons.saveLog({
        content: `<a href="/user/profile/${this.getUid()}">${this.getUsername()}</a> 更新了 <a href="/project/${projectId}/qywechat_robots">钉钉机器人</a> 的信息`,
        type: 'project',
        uid: this.getUid(),
...
module.exports = QywechatRobotsController;
