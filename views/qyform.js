...
class QywechatRobotView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ddingHooks: [],
  ...
  async componentDidMount() {
      ...
      let resp = await axios.get('/api/plugin/qywechat_robots/detail', {params: {project_id: projectId}});
  ...
  test = (id, e) => {
      ...
      if (url) {
          axios.post('/api/plugin/qywechat_robots/test', {url}).then((resp) => {
  ...
  submit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      ...
      this.submitData('/api/plugin/qywechat_robots/up', payload);
    })
  }
...
export default Form.create()(QywechatRobotView);
